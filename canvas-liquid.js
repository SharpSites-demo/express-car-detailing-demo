/*! Canvas UI — Liquid (vanilla WebGL build). Source: github.com/DavidHDev/canvas-ui by David Haz. License: MIT + Commons Clause v1.0 — see /canvas-ui/LICENSE. */
var CanvasLiquid = (() => {
...
void main () {
  ...
  var FRAG_ADVECT = `#version 300 es
precision highp float;
in vec2 vUv;
out vec4 outColor;
...
void main () {
  ...
  var FRAG_DIVERGENCE = `#version 300 es
precision highp float;
in vec2 vUv;
in vec2 vL;
in vec2 vR;
...
void main () {
  ...
  var FRAG_VORTICITY = `#version 300 es
precision highp float;
in vec2 vUv;
in vec2 vL;
in vec2 vR;
...
void main () {
  ...
  var FRAG_PRESSURE = `#version 300 es
precision highp float;
in vec2 vUv;
in vec2 vL;
in vec2 vR;
...
void main () {
  ...
  return __toCommonJS(LiquidVanilla_exports);
})();
